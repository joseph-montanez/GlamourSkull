...
<html>
<head>
    <cfparam name="page.h1" default="">
    <cfparam name="page.description" default="">
    <cfparam name="page.keywords" default="">
...
<body>
    ...
    <div style="width: 954px; padding: 1em 0 0 0; margin: 0 auto; text-align: left;" id="container">
        <cfoutput>
            <h1 class="item-name">#page.h1#</h1>
            #page.data#
        </cfoutput>
    </div>
    <div id="footer">&copy 2012 GlamourSkull</div>
</body>
</html>